...
なんとか＋체언으로 구성된 구는 어쩌구(무슨)+N의 의미를 갖는다고 보는 것이 더 적절하다. 물론 맥락에 따라 어떻게든+N으로 해석되는 경우도 있겠지만, "어떻게든"이라는 부사 자체가 동사를 꾸미는 놈이므로, 후행하는 동사가 없다면 대체로 어쩌구+N으로 보자. 우미챠님의 「なんとか鉄道の夕」도 마찬가지다.

그리고 애초에 이노우츠하SA상은 [츠쿠미즈](https://www.google.com/search?q=시메지+시뮬레이션){:target="_blank"}님의 광팬이라는 걸 잊지 말자. 

(이노우츠하SA: 아 그 어쩌구 시뮬레이션 있잖아 그거...)
